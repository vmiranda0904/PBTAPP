...
Open the app in Chrome, Edge, or Safari (iOS 16.4+). A **Download App** button in the sidebar lets you install it directly to your device — it works offline and behaves like a native app.
